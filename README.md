...
一个基于 Claude Code + OpenClaw 的定制化 AI Agent，集成金融投研5大技能，支持微信一对多服务，每个用户独立记忆隔离。
...
| 深度研究 | 行业全景/企业深度/联合研究（三模式自动切换） | Tavily + Brave |
...
| 技能 | 功能 | 场景 |
|------|------|------|
| 销售军师 | 客户刁钻问题实时应答，合规话术生成 | 投顾与客户沟通时一键咨询 |
| 客户沙盘推演 | 客户池优先级评估，开发顺序优化 | 每周客户盘点、拜访计划制定 |
| 上市公司业务匹配 | 目标公司分析+己方业务线匹配 | 机构拜访前准备材料 |
